...
const pricingTiers = [
    {
        ...
        features: [
            ...
            "Portraits, dates, and relationship cards",
            "Drag and arrange your branches",
        ],
        cta: "Start Free",
        href: "/auth",
        highlighted: false,
...
function Hero() {
    return (
        <section className="relative overflow-hidden">
            ...
            <div
                className="relative max-w-content mx-auto px-margin pt-16 pb-20 sm:pt-24 sm:pb-28
                      grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-16 items-center"
            >
                {/* Left: editorial text column */}
                <div className="lg:col-span-5 lg:pr-4">
                    <span className="label-meta block mb-5">
                        Est. for the family record
                    </span>
                    ...
                    <p className="font-sans text-body-lg text-ink-variant max-w-md mb-9 leading-relaxed">
                        Build a living family tree alongside the people in it.
                        Add portraits, dates, and relationship links, then
                        invite relatives to help fill in every branch.
                    </p>
                    ...
                    <p className="font-sans text-xs text-ink-variant/80 max-w-sm leading-relaxed">
                        Free to start. No credit card. Twenty family members on
                        the house — enough for most living branches.
                    </p>
                </div>
            ...
            <div className="max-w-content mx-auto px-margin py-24 sm:py-32 space-y-28 sm:space-y-36">
                ...
                <article className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-10 items-center">
                    ...
                    <div className="lg:col-span-5 lg:pl-6 order-1 lg:order-2">
                        ...
                        <p className="text-ink-variant text-body-lg leading-relaxed">
                            Drag, link, and arrange every branch like an
                            heirloom in progress. The whole family is visible at
                            once — no hidden pages, no buried records.
                        </p>
                    </div>
                </article>
                ...
                <article className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-10 items-center">
                    <div className="lg:col-span-5 lg:pr-6">
                        ...
                        <p className="text-ink-variant text-body-lg leading-relaxed mb-5">
                            Add portraits, birth and passing dates, and partner
                            / child connections to each profile card. Every
                            update stays pinned to the family map.
                        </p>
                        <ul className="space-y-2 text-sm text-ink-variant">
                            <li>— Portraits, names, and life dates</li>
                            <li>— Partner, parent, and child links</li>
                            <li>— Reposition cards with drag-and-drop ease</li>
                        </ul>
                    </div>
                ...
                <article className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-10 items-center">
                    <div className="lg:col-span-5 lg:pl-2">
                        ...
                        <p className="text-ink-variant text-body-lg leading-relaxed">
                            The curator builds the bones. Aunts, uncles, and
                            cousins fill in what only they remember. Every
                            contribution is attributed quietly, the way a
                            kitchen-table conversation is.
                        </p>
                    </div>
                    <div className="lg:col-span-7">
                        <CollaboratorRail />
        ...
        <section className="bg-container-low border-t border-outline-variant/60">
            <div className="max-w-4xl mx-auto px-margin py-24 sm:py-28">
                <div className="max-w-xl mb-12">
                    ...
                    <p className="text-ink-variant text-body-lg leading-relaxed">
                        Begin freely. Upgrade only when your family outgrows the
                        free tier — most never need to.
                    </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-gutter">
                    {pricingTiers.map((tier) => (
                        ...
                        >
                            <div className="mb-6">
                                <h3
                                    className={`font-serif text-xl font-semibold mb-1 ${tier.highlighted ? "text-primary-on" : "text-ink"}`}
                                >
                                    {tier.name}
                                </h3>
                                <p
                                    className={`text-sm mb-5 ${tier.highlighted ? "text-primary-on-container" : "text-ink-variant"}`}
                                >
                                    {tier.description}
                                </p>
                                <div className="flex items-end gap-1">
                                    <span
                                        className={`font-serif text-5xl font-semibold ${tier.highlighted ? "text-primary-on" : "text-ink"}`}
                                    >
                                        {tier.price}
                                    </span>
                                    <span
                                        className={`text-sm pb-2 ${tier.highlighted ? "text-primary-on-container" : "text-ink-variant"}`}
                                    >
                                        /{tier.period}
                                    </span>
                                </div>
                            ...
                            <ul className="space-y-2.5 mb-8 flex-1">
                                {tier.features.map((feat) => (
                                    ...
                                    >
                                        <svg
                                            className={`w-4 h-4 mt-0.5 flex-shrink-0 ${tier.highlighted ? "text-tertiary-fixed-dim" : "text-primary"}`}
                                            viewBox="0 0 20 20"
                                            fill="currentColor"
                                            aria-hidden="true"
                                        >
        ...
        <footer className="py-10 border-t border-outline-variant/60 bg-surface">
            <div className="max-w-content mx-auto px-margin flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <p className="text-sm text-ink-variant">
                    &copy; {year} Rooted Heritage. All rights reserved.
                </p>
...
function Connector() {
    return (
        <div className="w-px h-6 bg-outline-variant/80" aria-hidden="true" />
    );
}
...
function MockCard({ node, hovered, setHovered }) {
    ...
    return (
        ...
        >
            <div
                className="w-9 h-9 rounded-full bg-tertiary-fixed mx-auto mb-1.5 flex items-center
    ...
    return (
        <div className="relative rounded-xl border border-outline-variant/60 bg-container-lowest shadow-card p-8 sm:p-10">
            ...
            >
                ...
                >
                    <text x="20" y="35" textTransform="uppercase">
                        Gen I
                    </text>
                    <text x="20" y="185" textTransform="uppercase">
                        Gen II
                    </text>
                    <text x="20" y="285" textTransform="uppercase">
                        Gen III
                    </text>
                </g>
                {/* nodes */}
        ...
        <div className="rounded-xl border border-outline-variant/60 bg-container-lowest shadow-card overflow-hidden">
            <div className="grid grid-cols-5">
                ...
                <div className="col-span-2 bg-tertiary-fixed flex items-center justify-center aspect-square sm:aspect-auto">
                    <div
                        className="w-24 h-24 rounded-full bg-tertiary-fixed-dim border-2 border-tertiary-on-container/20
                ...
                <div className="col-span-3 p-6 sm:p-7">
                    ...
                    <ul className="space-y-2 text-sm text-ink-variant border-l border-tertiary-accent/40 pl-3">
                        <li>
                            <span className="font-semibold text-ink">1957</span>{" "}
                            — Married George in Bergen.
                        </li>
                        <li>
                            <span className="font-semibold text-ink">1962</span>{" "}
                            — Welcomed James, eldest of four.
                        </li>
                        <li>
                            <span className="font-semibold text-ink">1971</span>{" "}
                            — Family migrated to Boston.
                        </li>
                        <li className="italic text-ink-variant/80">
                            "Her cardamom buns. Always.&rdquo;
                        </li>
                    </ul>
                </div>
            </div>
    ...
    const people = [
        {
            ...
            name: "Emily",
            note: "curator",
            tone: "bg-primary-fixed text-primary-700",
        },
        {
            initial: "A",
            name: "Aunt Marie",
            note: "added 14 photos",
            tone: "bg-tertiary-fixed text-tertiary-on-container",
        },
        {
            initial: "D",
            name: "Dad",
            note: "added 3 stories",
            tone: "bg-container-high text-ink-variant",
        },
        {
            initial: "C",
            name: "Cousin Jo",
