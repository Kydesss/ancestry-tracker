    ...
    return (
        <div className="bg-container-lowest rounded-md border border-outline-variant shadow-card hover:shadow-card-hover focus-within:shadow-card-hover transition-all duration-300 w-52 relative group">
            ...
            <Handle
                ...
                className="!bg-tertiary-accent !w-3 !h-3 opacity-60 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity"
            />
            <Handle
                id="bottom"
                type="source"
            ...
            <div className="p-4">
                ...
                <div className="flex flex-col items-center text-center mb-3">
                    <Avatar
                        ...
                        size="xl"
                    />
                    <h3 className="mt-2 font-serif text-base font-semibold text-ink leading-tight">
                        {member.name}
                    </h3>
                    ...
                    <div className="mt-1.5 text-xs text-ink-variant space-y-0.5 font-sans">
                        ...
                        {member.dod && (
                            <p className="text-outline tabular-nums">
                                d. {format(member.dod)}
                            </p>
                        )}
                    </div>
                ...
                <div className="flex justify-center gap-2">
                    <button
                        ...
                        className="min-h-[36px] min-w-[36px] p-2 rounded bg-container-low hover:bg-primary-fixed focus:bg-primary-fixed text-ink-variant hover:text-primary focus:text-primary focus:outline-none focus:ring-2 focus:ring-primary-300 transition-colors flex items-center justify-center"
                    ...
                    <button
                        ...
                        className="min-h-[36px] min-w-[36px] p-2 rounded bg-container-low hover:bg-danger-container focus:bg-danger-container text-ink-variant hover:text-danger-on-container focus:text-danger-on-container focus:outline-none focus:ring-2 focus:ring-danger/40 transition-colors flex items-center justify-center"
            ...
            {confirmDelete && (
                <div className="absolute inset-0 bg-container-lowest/95 backdrop-blur-sm rounded-md flex flex-col items-center justify-center p-4 z-10">
                    <p className="font-serif text-sm font-semibold text-ink text-center mb-1">
                        Remove {member.name}?
                    </p>
                    <p className="text-xs text-ink-variant text-center mb-4">
                        This also removes all their relationships.
                    </p>
