    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-5 border-b border-outline-variant/50 flex-shrink-0">
          <span className="font-serif text-lg font-semibold text-primary tracking-tight">Rooted Heritage</span>
          <button
            onClick={onClose}
        ...
        <div className="px-4 pt-4 pb-1">
          ...
          >
            {subscriptionTier === 'premium' ? '✦ Heirloom' : 'Free Trial'}
          </span>
        </div>
        ...
        <nav className="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
          {navItems.map(({ label, icon: Icon, href, premium }) => (
            ...
            >
              ...
              <span>{label}</span>
              {premium && !isPremium && (
                <svg className="w-3.5 h-3.5 ml-auto text-tertiary-accent" viewBox="0 0 20 20" fill="currentColor">
          ...
          {!isPremium && (
            ...
            >
              <svg className="w-4 h-4 flex-shrink-0 text-tertiary-accent" viewBox="0 0 20 20" fill="currentColor">
