...
const features = [
    {
        ...
        description:
            "Compose your lineage on a tactile canvas. Drag, link, and arrange generations like an heirloom in progress.",
    },
    {
        icon: PeopleGlyph,
        title: "Real-Time Collaboration",
        description:
            "Invite relatives to view or curate the tree together — every memory captured, no detail lost.",
    },
    {
        icon: FrameGlyph,
        title: "Profiles & Portraits",
        description:
            "Affix portraits, life dates, and stories to each ancestor — a portrait gallery for your family.",
    },
    {
        icon: TimelineGlyph,
        title: "Chronological Timeline",
        description:
            "See generations laid out chronologically — discover patterns and the threads that bind them.",
    },
];
        ...
        <div className="min-h-screen bg-surface text-ink">
            ...
            <nav className="sticky top-0 z-50 bg-surface/85 backdrop-blur border-b border-outline-variant/60">
                <div className="max-w-content mx-auto px-margin sm:px-margin flex items-center justify-between h-16">
                    <Link
                        to="/"
                        className="font-serif text-xl font-semibold text-primary tracking-tight"
                    >
                        Rooted
                    </Link>
            ...
            <section className="relative overflow-hidden pt-20 pb-28 sm:pt-28 sm:pb-36">
                ...
                <div className="relative max-w-4xl mx-auto px-margin text-center">
                    ...
                    <p className="font-sans text-body-lg text-ink-variant max-w-2xl mx-auto mb-10">
                        Build enduring, interactive family trees. Collaborate
                        with relatives in real time and preserve your heritage
                        as a digital heirloom for generations to come.
                    </p>
            ...
            <section className="py-20 sm:py-28 max-w-content mx-auto px-margin">
                <div className="text-center mb-14 max-w-2xl mx-auto">
                    ...
                    <p className="text-ink-variant text-body-lg">
                        Considered tools to document your family history with
            ...
            <section className="py-20 sm:py-28 bg-container-low border-y border-outline-variant/60">
                <div className="max-w-4xl mx-auto px-margin">
                    <div className="text-center mb-14 max-w-xl mx-auto">
                        ...
                        <p className="text-ink-variant text-body-lg">
                            Begin freely. Upgrade when your family grows.
                        </p>
                    </div>
            ...
            <footer className="py-10 border-t border-outline-variant/60 bg-surface">
                <div className="max-w-content mx-auto px-margin flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-sm text-ink-variant">
                        &copy; {new Date().getFullYear()} Rooted. All rights
                        reserved.
                    </p>
...
function MockCard({ node }) {
    ...
    return (
        <div
            className={`rounded-md border px-4 py-2.5 text-center shadow-card min-w-[120px] ${tones[node.tone]}`}
        >
            ...
            <p className="text-[11px] uppercase tracking-wider font-semibold text-ink-variant mt-0.5">
                {node.role}
            </p>
        </div>
    );
